...
public class PlayerData {
    ...
    private TickTimer lastMovementCancel = new TickTimer(4),
            ...
            lastStopUsingItem = new TickTimer(0),
            lastInvClick = new TickTimer(0),
            lastAbleToFly = new TickTimer(0),
            lastBlockBreakStop = new TickTimer(30);
    ...
    public PlayerData(UUID uuid) {
        ...
        if(CheckSettings.enableOnJoin && player.hasPermission("iris.alerts")) alertsEnabled = true;

        actionProcessor = new ActionProcessor();
        velocityProcessor = new VelocityProcessor();
        movementProcessor = new MovementProcessor();

        Iris.getInstance().getCheckManager().loadChecksIntoData(this);
