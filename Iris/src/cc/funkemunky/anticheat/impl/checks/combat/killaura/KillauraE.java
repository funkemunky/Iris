...
public class KillAuraE extends Check {
    ...
    public KillAuraE(String name, CancelType cancelType, int maxVL, boolean enabled, boolean executable, boolean cancellable) {
    ...
    public void onPacket(Object packet, String packetType, long timeStamp) {
        ...
        if (yawDeque.size() == 5 && pitchDeque.size() == 5) {
            ...
            if ((pitchAverage >= 10.8F && yawAverage >= 5.6) && level.get() >= 3 && level.get() < 6) {
